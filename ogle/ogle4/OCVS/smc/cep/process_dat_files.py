...
def main():
    dat_files = ["cep1O", "cep1O2O", "cep1O2O3O", "cep2O", "cepF", "cepF1O"]
...
def combine_dat_files(dat_files):
    ...
    cep2O_dat = pd.read_csv(dat_files[3] + ".csv")
    cepF_dat = pd.read_csv(dat_files[4] + ".csv")
    cepF1O_dat = pd.read_csv(dat_files[5] + ".csv")
    ...
    all_dat = pd.concat([cep1O_dat, cep1O2O_dat, cep1O2O3O_dat, cep2O_dat, cepF_dat, cepF1O_dat])
